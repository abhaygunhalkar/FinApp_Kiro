...
export default function ETFHoldings() {
  ...
  const handleRefreshPrices = async () => {
    ...
    try {
      ...
      // Silently fail; prices update on next refresh.
    } finally {
    ...
    return (
      <div className="p-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
          Track your ETF investments in one place.
        </p>
        <EmptyState
          icon={
          ...
          title="No ETF holdings yet"
          description="Add your first ETF holding to start tracking your portfolio."
          actionLabel="Add ETF Holding"
          onAction={() => setShowAddForm(true)}
        />

        {showAddForm && (
          <HoldingForm holdingType="etf" onClose={() => setShowAddForm(false)} />
        )}
      </div>
    );
  }
